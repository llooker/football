view: team_game {
  sql_table_name: fantasy_football.team_game ;;
...
#   }
  ...
  dimension: opponent_time_of_possession_minutes {
    type: number
    sql: ${TABLE}.OpponentTimeOfPossessionMinutes ;;
  }

  dimension: opponent_time_of_possession_seconds {
    type: number
    sql: ${TABLE}.OpponentTimeOfPossessionSeconds ;;
  }
  ...
  dimension: time_of_possession_minutes {
    type: number
    sql: ${TABLE}.TimeOfPossessionMinutes ;;
  }

  dimension: time_of_possession_seconds {
    type: number
    sql: ${TABLE}.TimeOfPossessionSeconds ;;
  }
